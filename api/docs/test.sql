...
CREATE TABLE IF NOT EXISTS `homeworks_test`.`users` (
...
ENGINE = InnoDB;
CREATE TABLE IF NOT EXISTS `homeworks_test`.`lecturers` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `firstName` VARCHAR(45) NOT NULL,
  `lastName` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `fk_lecturers_users`
    ...
    REFERENCES `homeworks_test`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
CREATE TABLE IF NOT EXISTS `homeworks_test`.`subjects` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_subjects_lecturers1`
    ...
    REFERENCES `homeworks_test`.`lecturers` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
CREATE TABLE IF NOT EXISTS `homeworks_test`.`homeworks` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `name` VARCHAR(45) NOT NULL,
  ...
  CONSTRAINT `fk_homeworks_subjects1`
    ...
    REFERENCES `homeworks_test`.`subjects` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
